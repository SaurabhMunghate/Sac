...
public class ShatamIndexWriter
{
    ...
    public void write(AddressStruct addStruct) throws Exception
    {
        ...
        for (AbstractIndexType it : AbstractIndexType.TYPES){
        	...
        	//U.log("index type=="+it.getFieldName());
        	//if(it.getFieldName().contains("k1"))normalquery=query;
            //U.log("SAMIR sir SAID TO CHK IT::::::::::::::"+query);
        ...
        for (AddColumns col : AddColumns.values())
        {
           ...
           // U.log("normalquery=="+normalquery);
           // U.log("col:" + col.toString() + "  :" + v);
           // if(v.contains("martin luther"))Thread.sleep(4000);
            //if(col.toString().contains("NAME")&&!normalquery.contains(v.toLowerCase().trim())){
            	//U.log("Kirti misal");
            	//Thread.sleep(4000);
