...
public class JaroWinklerDistance 
{
	...
	public static void main(String args[])
	{
		...
		System.out.println(new JaroWinklerDistance().getSimilarity("VIA DE SUENO", "VIA DE SANTA FE"));
		System.out.println(new JaroWinklerDistance().getSimilarity("AVENIDA BRISA","AVENIDA ALONDRA"));
		System.out.println(new JaroWinklerDistance().getSimilarity("AVENDA ANALO","AVENIDA ALONDRA"));
		System.out.println(new JaroWinklerDistance().getSimilarity("AVENIDA ALONA","AVENIDA ALONDRA"));
