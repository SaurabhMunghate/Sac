...
public class CustomAddressCorrector {
	...
	public  MultiMap corrUsingAppropriateIndex(
			MultiMap multimap,String maxresult,String hitscore ,String noOfJobs,String dataSource,boolean flag) throws Exception {
			...
			//	 //U.log("  *** " + it.getFieldName() + " / " + dataSource);
				...
				returnoutput = shatamIndexUtil
						.correctAddresses(multimap,
								null,null,maxresult,hitscore,noOfJobs,dataSource,flag);
