...
import com.shatam.shatamindex.index.MultipleTermPositions;
...
public class MultiPhraseQuery extends Query {
	...
	private class MultiPhraseWeight extends Weight {
		...
		public Scorer scorer(IndexReader reader, boolean scoreDocsInOrder,
			...
			for (int pos = 0; pos < postingsFreqs.length; pos++) {
				...
				postingsFreqs[pos] = new PhraseQuery.PostingsAndFreq(p,
						docFreq, positions.get(pos).intValue(), terms[0]);
			}
	...
	@Override
	public int hashCode() {
		return Float.floatToIntBits(getBoost()) ^ slop ^ termArraysHashCode()
	...
	private boolean termArraysEquals(List<Term[]> termArrays1,
			List<Term[]> termArrays2) {
		...
		while (iterator1.hasNext()) {
			...
			if (!(termArray1 == null ? termArray2 == null : Arrays.equals(
					termArray1, termArray2))) {
				return false;
			}
		}
		return true;
