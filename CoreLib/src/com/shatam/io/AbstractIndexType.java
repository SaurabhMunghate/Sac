...
public abstract class AbstractIndexType
{
    ...
    public static final AbstractIndexType METAPHONE        = new CodecIndexType("k2", new Metaphone());
    public static final AbstractIndexType SOUNDEX          = new CodecIndexType("k3", new Soundex());
    public static final AbstractIndexType DOUBLE_METAPHONE = new CodecIndexType("k4", new DoubleMetaphone());
    public static final AbstractIndexType REFINED_SOUNDEX  = new CodecIndexType("k5", new RefinedSoundex());

  //  public static AbstractIndexType[]     TYPES            = { NORMAL, METAPHONE, SOUNDEX,DOUBLE_METAPHONE, REFINED_SOUNDEX };//

    public static AbstractIndexType[]     TYPES            = { NORMAL, METAPHONE, SOUNDEX};
    ...
    private void _app(StringBuffer buf, AddColumns col, AddressStruct struct) throws Exception
    {
